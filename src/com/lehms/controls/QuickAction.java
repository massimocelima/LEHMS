...
public class QuickAction extends CustomPopupWindow {
	...
	public QuickAction(View anchor) {
		...
		root		= (ViewGroup) inflater.inflate(R.layout.quick_actions_popup, null);
		
		mArrowDown 	= (ImageView) root.findViewById(R.id.quick_actions_arrow_down);
		mArrowUp 	= (ImageView) root.findViewById(R.id.quick_actions_arrow_up);
		
		setContentView(root);
	    
		mTrack 			= (ViewGroup) root.findViewById(R.id.quick_actions_tracks);
		scroller		= (ScrollView) root.findViewById(R.id.quick_actions_scroller);
		animStyle		= ANIM_AUTO;
	}
	...
	public void show () {
		...
		showArrow(((onTop) ? R.id.quick_actions_arrow_down : R.id.quick_actions_arrow_up), anchorRect.centerX()-xPos);
	...
	private View getActionItem(String title, Drawable icon, OnClickListener listener) {
		LinearLayout container	= (LinearLayout) inflater.inflate(R.layout.quick_actions_action_item, null);
		
		ImageView img			= (ImageView) container.findViewById(R.id.quick_actions_icon);
		TextView text			= (TextView) container.findViewById(R.id.quick_actions_title);
	...
	private void showArrow(int whichArrow, int requestedX) {
        final View showArrow = (whichArrow == R.id.quick_actions_arrow_up) ? mArrowUp : mArrowDown;
        final View hideArrow = (whichArrow == R.id.quick_actions_arrow_up) ? mArrowDown : mArrowUp;
