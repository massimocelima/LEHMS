...
public class ListQuickAction extends CustomPopupWindow {
	 ...
	 */
	public ListQuickAction(View anchor) {
		super(anchor);
		...
		root		= (ViewGroup) inflater.inflate(R.layout. list_quick_action_popup, null);
	...
	private View getActionItem(String title, Drawable icon, OnClickListener listener) {
		LinearLayout container	= (LinearLayout) inflater.inflate(R.layout.list_quick_action_item, null);
