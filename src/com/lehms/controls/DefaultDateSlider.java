...
public class DefaultDateSlider extends DateSlider {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ScrollLayout mMonthScroller = (ScrollLayout) inflater.inflate(R.layout.dateslider_scroller, null);
		...
		// create the month scroller and assign its labeler and add it to the layout
		ScrollLayout mDayScroller = (ScrollLayout) inflater.inflate(R.layout.dateslider_scroller, null);
	...
	protected Labeler monthLabeler = new Labeler() {
		...
		public TimeView createView(Context context, boolean isCenterView) {
			return new com.lehms.controls.TimeView.TimeLayoutView(context, isCenterView,25,8,0.95f);
		}
	...
	protected Labeler dayLabeler = new Labeler() {
		 ...
		 */
		public TimeView createView(Context context, boolean isCenterView) {
			return new com.lehms.controls.TimeView.DayTimeLayoutView(context, isCenterView,30,8,0.8f);
		}
